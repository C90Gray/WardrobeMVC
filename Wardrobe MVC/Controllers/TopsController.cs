...
namespace Wardrobe_MVC.Controllers
{
    public class TopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopID,TopName,TopPic,TopColor,SeasonID,OccasionID")] Top top)
        {
            ...
            ViewBag.SeasonID = new SelectList(db.Seasons, "SeasonID", "SeasonType", top.SeasonID);
            return View(top);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopID,TopName,TopPic,TopColor,SeasonID,OccasionID")] Top top)
        {
            if (ModelState.IsValid)
            {
