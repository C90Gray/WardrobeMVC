...
namespace Wardrobe_MVC.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomID,BottomName,BottomPic,BottomColor,SeasonID,OccasionID")] Bottom bottom)
        {
            ...
            ViewBag.SeasonID = new SelectList(db.Seasons, "SeasonID", "SeasonType", bottom.SeasonID);
            return View(bottom);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomID,BottomName,BottomPic,BottomColor,SeasonID,OccasionID")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
