...
namespace Wardrobe_MVC.Controllers
{
    public class AccessoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AccessoryID,AccessoryName,AccessoryPic,AccessoryColor,SeasonID,OccasionID")] Accessory accessory)
        {
            ...
            ViewBag.SeasonID = new SelectList(db.Seasons, "SeasonID", "SeasonType", accessory.SeasonID);
            return View(accessory);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccessoryID,AccessoryName,AccessoryPic,AccessoryColor,SeasonID,OccasionID")] Accessory accessory)
        {
            if (ModelState.IsValid)
            {
